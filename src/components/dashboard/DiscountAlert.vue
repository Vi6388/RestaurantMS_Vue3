...
import { DiscountsAlertsData } from '@/data/Dashboard';
</script>
<template>
    <v-card elevation="10">
        <v-card-item class="pb-4">
            <div class="flex justify-between mb-3 align-center">
                <v-card-title class="text-h5 mb-0">Discount Alert</v-card-title>
            </div>
            <div>
                <div v-for="item in DiscountsAlertsData" :key="item.id">
